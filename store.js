...
module.exports = {
	...
	setCanaryAlert: function ()
	{
		client.set("canaryAlert", true);
	},
	getCanaryAlert: function (callback)
	{
		client.get("canaryAlert", function(err, value){
			return callback(value);
		});
	},
	delCanaryAlert: function ()
	{
		client.del("canaryAlert");
	},
